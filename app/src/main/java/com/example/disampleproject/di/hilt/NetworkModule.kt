...
import com.example.disampleproject.data.datasource.MealDataSourceWithHilt
import com.example.disampleproject.util.Constants.APP_JSON
...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideMealRemoteDataSource(mealApi: MealApi): MealDataSource {
        return MealDataSourceWithHilt(mealApi)
    }
}